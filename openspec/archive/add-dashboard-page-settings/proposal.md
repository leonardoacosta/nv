# Proposal: Add Dashboard Page Settings

## Change ID
`add-dashboard-page-settings`

## Summary
Editable agent config, quiet hours, obligation detection. Dropdowns, inputs, toggles.
...
Editable agent config, quiet hours, obligation detection. Dropdowns, inputs, toggles. Reference wireframe for layout and interaction patterns.
