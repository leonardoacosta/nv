...
- [x] [4.1] Verify daemon compiles after changes -- `pnpm typecheck` passes with no errors in `packages/daemon`. No dangling imports, no unused variables, no type mismatches in the queue integration. [owner:e2e-engineer]
