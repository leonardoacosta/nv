...
- [x] [3.5] [P-2] Reload systemd units and restart services [owner:devops-engineer]
- [x] [3.6] [P-2] Verify all services running [owner:devops-engineer]
- [x] [3.7] [P-3] Remove `~/.nv/env` once migration verified (backup at ~/.nv/env.bak) [owner:devops-engineer]
