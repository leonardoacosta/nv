...
import { heading, subheading, green, yellow, gray, padRight, } from "../lib/format.js";
const DAEMON_PORT = 8400;
async function runDream(dryRun) {
...
export async function dreamCmd(subcommand, dryRun = false) {
    try {
