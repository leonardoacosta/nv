/**
 * SOCKS5 HTTP client for teams-svc — routes requests through localhost:1080 via curl.
 *
 * Same pattern as graph-svc/socks-client.ts. Uses `curl --socks5-hostname`
 * via child_process. No npm dependency needed.
 */
